...
public class DBConfig 
{
	...
	public DataSource getH2DataScorce() 
	{
		DriverManagerDataSource dataSource = new DriverManagerDataSource();
		dataSource.setDriverClassName("org.h2.Driver");
		dataSource.setUrl("jdbc:h2:tcp://localhost/~/united");
	...
	public SessionFactory getSessionFactory() {
		...
		LocalSessionFactoryBuilder localsessionFactory = new LocalSessionFactoryBuilder(getH2DataScorce());
